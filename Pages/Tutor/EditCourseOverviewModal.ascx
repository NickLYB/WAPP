<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditCourseOverviewModal.ascx.cs"
    Inherits="WAPP.Pages.Tutor.EditCourseOverviewModal" %>
                ...
                <ContentTemplate>
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="form-row mb-3 d-flex align-items-start">
                            ...
                            <asp:TextBox ID="txtDesc" runat="server" CssClass="form-control flex-grow-1"
