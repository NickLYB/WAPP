...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-layout-split">
        ...
        <div class="layout-main-70">
            <div class="ec-hero mb-4" style="display: flex; align-items: center; gap: 20px;">
            ...
            <div class="layout-grid-half mb-4" style="align-items: start;">
                ...
                <div class="ec-glass-card w-100 align-self-start">
                    <div class="ec-glass-card-header border-0 pb-0 d-flex justify-content-between align-items-center mb-3">
                        <h5 class="fw-bold m-0"><i class="bi bi-bar-chart-fill text-primary me-2"></i>Teaching Overview</h5>
                        <button class="btn btn-sm btn-light rounded-circle shadow-sm widget-toggle-btn" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOverview">
                    ...
                    <div class="collapse show" id="collapseOverview">
                        <div class="ec-glass-card-body pt-0 d-flex flex-column" style="height: 300px;">
                            ...
                            <div class="d-flex justify-content-between text-center m-auto w-100" style="gap: 15px;">
                ...
                <div class="ec-glass-card w-100 align-self-start">
                    <div class="ec-glass-card-header border-0 pb-2 mb-2 d-flex justify-content-between align-items-center">
                        <h5 class="fw-bold m-0"><i class="bi bi-megaphone-fill text-warning me-2"></i>Recent Announcements</h5>
                        <button class="btn btn-sm btn-light rounded-circle shadow-sm widget-toggle-btn" type="button" data-bs-toggle="collapse" data-bs-target="#collapseAnnouncements">
                            <i class="bi bi-dash"></i>
                        </button>
                    </div>
                    ...
                    <div class="collapse show" id="collapseAnnouncements">
                        <div class="ec-glass-card-body p-0" style="height: 300px;">
                            <asp:UpdatePanel ID="upDashboardAnnouncements" runat="server" UpdateMode="Conditional" style="height: 100%;">
                                <ContentTemplate>
                                    
                                    <div class="d-flex flex-column h-100">
                                        
                                        <div class="p-3 flex-grow-1 overflow-auto" style="max-height: 230px;">
                                            <asp:Repeater ID="rptRecentAnnouncements" runat="server">
                                                <ItemTemplate>
                                                    <div class="ec-feed-item flex-column align-items-start mb-3 pb-3 border-bottom">
                                            ...
                                            <asp:Label ID="lblNoAnnouncements" runat="server" Visible="false" Text="No recent announcements." CssClass="text-muted text-center d-block my-3"></asp:Label>
                                        </div>
                                        
                                        <div class="ec-card-actions border-top pt-3 p-3 mt-auto">
            ...
            <div class="ec-glass-card mb-4">
                <div class="ec-glass-card-header border-0 pb-2 mb-2 d-flex justify-content-between align-items-center">
                    <h5 class="fw-bold m-0"><i class="bi bi-calendar-check-fill text-success me-2"></i>Session Appointments</h5>
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <button class="btn btn-sm btn-light rounded-circle shadow-sm widget-toggle-btn" type="button" data-bs-toggle="collapse" data-bs-target="#collapseAppointments">
                            <i class="bi bi-dash"></i>
                        </button>
                    </div>
                </div>
                
                <div class="collapse show" id="collapseAppointments">
                    <div class="ec-glass-card-body pt-0">
            ...
            <div class="ec-glass-card mb-4">
                <div class="ec-glass-card-header border-0 pb-2 mb-2 d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <button class="btn btn-sm btn-light rounded-circle shadow-sm widget-toggle-btn" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMessagesTutor">
                            <i class="bi bi-dash"></i>
                        </button>
                    </div>
                </div>
                
                <div class="collapse show" id="collapseMessagesTutor">
        ...
        </div> <div class="layout-sidebar-30">
            <div class="ec-glass-card mb-4">
                ...
                <asp:UpdatePanel ID="upNotifications" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <div class="ec-glass-card-header border-0 pb-2 mb-2 d-flex justify-content-between align-items-center">
                            ...
                            <button class="btn btn-sm btn-light rounded-circle shadow-sm widget-toggle-btn" type="button" data-bs-toggle="collapse" data-bs-target="#collapseNotificationsTutor">
                                <i class="bi bi-dash"></i>
                            </button>
                        </div>

                        <div class="collapse show" id="collapseNotificationsTutor">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            collapseElements.forEach(function (collapseEl) {
                ...
                var isMinimized = localStorage.getItem("tutor_" + id + "_state") === "minimized";
                if (isMinimized) {
                ...
                collapseEl.addEventListener('shown.bs.collapse', function () {
                    localStorage.setItem("tutor_" + id + "_state", "maximized");
                    if (btnIcon) {
                ...
                collapseEl.addEventListener('hidden.bs.collapse', function () {
                    localStorage.setItem("tutor_" + id + "_state", "minimized");
                    if (btnIcon) {
                        btnIcon.classList.remove('bi-dash');
                        btnIcon.classList.add('bi-plus');
                    }
