<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProfileDropdown.ascx.cs" Inherits="WAPP.Pages.Tutor.ProfileDropdown" %>
...
<div class="dropdown">
    ...
    <ul class="dropdown-menu dropdown-menu-end p-3 shadow" aria-labelledby="profileDropdown" style="min-width: 220px;">
        ...
        <li><asp:HyperLink ID="hlProfile" runat="server" CssClass="dropdown-item" NavigateUrl="~/Pages/Tutor/Profile.aspx">My Profile</asp:HyperLink></li>
        <li><asp:HyperLink ID="hlSettings" runat="server" CssClass="dropdown-item" NavigateUrl="~/Pages/Tutor/Settings.aspx">Settings</asp:HyperLink></li>
        <li><hr class="dropdown-divider"></li>
        <li>
