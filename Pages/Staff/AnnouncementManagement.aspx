<%@ Page Title="Announcement Management" Language="C#" MasterPageFile="~/Masters/Staff.Master" AutoEventWireup="true" CodeBehind="AnnouncementManagement.aspx.cs" Inherits="WAPP.Pages.Staff.AnnouncementManagement" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="upAnnounceMgmt">
    ...
    <div class="ec-staff-wrapper container-fluid mt-4">
        ...
        <h2 class="ec-staff-title text-uppercase mb-4">Operational Announcements</h2>
            
        <asp:UpdatePanel ID="upAnnounceMgmt" runat="server">
            <ContentTemplate>
                ...
                <div class="ec-staff-card mb-4 card shadow-sm">
                    <div class="card-body p-4">
                        ...
                        <div class="row mb-4 align-items-end">
                            ...
                            <div class="col-lg-2">
                                ...
                                <asp:DropDownList ID="ddlSortBy" runat="server" CssClass="form-select ec-filter-ddl w-100" AutoPostBack="true" OnSelectedIndexChanged="FilterGrid_Changed">
                                    <asp:ListItem Value="Latest">Newest First</asp:ListItem>
                            ...
                            <div class="col-lg-6 text-end d-flex justify-content-end align-items-center gap-2">
                                ...
                                <asp:Button ID="btnComposeRedirect" runat="server" Text="+ Compose Announcement" CssClass="btn btn-outline-primary rounded-pill fw-bold px-4 shadow-sm" OnClick="btnComposeRedirect_Click" />
                        ...
                        <div class="row g-2">
                            <div class="col-md-3">
                                <label class="form-label small text-muted mb-1 fw-bold">Target Group</label>
                            ...
                            <div class="col-md-3">
                                ...
                                <asp:DropDownList ID="ddlFilterStatus" runat="server" CssClass="form-select ec-filter-ddl w-100" AutoPostBack="true" OnSelectedIndexChanged="FilterGrid_Changed">
                                    ...
                                    <asp:ListItem Value="1">Active (Published)</asp:ListItem>
                            ...
                            <asp:GridView ID="gvAnnouncements" runat="server" CssClass="table table-hover ec-table-custom align-middle mb-0 border-top" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Message">
                                        <ItemTemplate>
                                            <span class="d-inline-block text-truncate text-muted" style="max-width: 250px;" title='<%# Eval("message") %>'><%# Eval("message") %></span>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="role_name" HeaderText="Target Group" NullDisplayText="All" />
                                    <asp:BoundField DataField="created_at" HeaderText="Created On" DataFormatString="{0:dd/MM/yyyy HH:mm}" />
                                    
                                    <asp:TemplateField HeaderText="Status">
                                        <ItemTemplate>
                                            <span class="badge rounded-pill fw-bold px-3 py-2 <%# Convert.ToBoolean(Eval("is_published")) ? "bg-success" : "bg-secondary" %>">
                                                <%# Convert.ToBoolean(Eval("is_published")) ? "ACTIVE" : "ARCHIVED" %>
                                            </span>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                <EmptyDataTemplate><tr><td colspan="100%" class="text-center py-4 text-muted">No announcements found matching your filters.</td></tr></EmptyDataTemplate>
                            </asp:GridView>
                        </div>
                            ...
                            <div class="ec-modal-body p-4 pt-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6 text-end">
                                        ...
                                        <div class="fw-bold text-dark"><asp:Literal ID="litViewStatus" runat="server"></asp:Literal></div>
                                    </div>
                                </div>
