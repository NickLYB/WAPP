<%@ Page Title="Operational Announcement Management" Language="C#" MasterPageFile="~/Masters/Staff.Master" AutoEventWireup="true" CodeBehind="AnnouncementManagement.aspx.cs" Inherits="WAPP.Pages.Staff.AnnouncementManagement" EnableEventValidation="false" %>
        ...
        function SearchTable() {
            ...
            if (visibleRows === 0) {
                if (!noRecRow) {
                    ...
                    cell.innerText = "No announcements found matching your filters.";
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="upAnnouncementMgmt">
    ...
    <div class="ec-staff-wrapper">
        ...
        <asp:UpdatePanel ID="upAnnouncementMgmt" runat="server">
            <ContentTemplate>
                        ...
                        <div class="row mb-4 align-items-end">
                            <div class="col-lg-4">
                                ...
                                <div class="input-group">
                                    <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control ec-search-input" Placeholder="Search Title, Message..." onkeydown="return handleEnter(event)"></asp:TextBox>
                            ...
                            <div class="col-lg-5 text-end d-flex flex-row justify-content-end gap-2">
                                <asp:Button ID="btnComposeRedirect" runat="server" Text="+ Add New Announcement" CssClass="btn btn-primary rounded-pill fw-bold px-4 shadow-sm" OnClick="btnComposeRedirect_Click" />
                                <asp:LinkButton ID="btnTriggerRemove" runat="server" CssClass="btn btn-danger rounded-pill fw-bold px-4 shadow-sm" OnClick="btnTriggerRemove_Click">- Remove Announcement</asp:LinkButton>
                            </div>
                        </div>
                        
                        <div class="row g-3">
                            <div class="col-md-3">
                                <label class="form-label small text-muted mb-1 fw-bold">Target Role</label>
                                <asp:DropDownList ID="ddlFilterRole" runat="server" CssClass="form-select ec-filter-ddl w-100" AutoPostBack="true" OnSelectedIndexChanged="FilterGrid_Changed">
                                    <asp:ListItem Value="All">All (Student &amp; Tutor)</asp:ListItem>
                            ...
                            <div class="col-md-3">
                                <label class="form-label small text-muted mb-1 fw-bold">Month Created</label>
                ...
                <div class="ec-staff-card">
                    <div class="card-body p-0"> 
                        <asp:GridView ID="gvAnnouncements" runat="server" CssClass="table table-hover ec-table-custom align-middle mb-0 border-top" 
                            ...
                            OnDataBound="gvAnnouncements_DataBound">
                            
                            <Columns>
                                <asp:TemplateField><ItemTemplate><asp:CheckBox ID="chkSelect" runat="server" /></ItemTemplate></asp:TemplateField>
                                <asp:BoundField DataField="Id" HeaderText="ID" DataFormatString="A{0:D3}" />
                                <asp:BoundField DataField="title" HeaderText="Title" />
                                <asp:TemplateField HeaderText="Message"><ItemTemplate><span class="ec-desc-truncate" title='<%# Eval("message") %>'><%# Eval("message") %></span></ItemTemplate></asp:TemplateField>
                                <asp:BoundField DataField="role_name" HeaderText="Target Role" NullDisplayText="Broadcast (All)" />
                                <asp:BoundField DataField="created_at" HeaderText="Date Created" DataFormatString="{0:dd/MM/yyyy HH:mm}" />
                                <asp:BoundField DataField="scheduled_at" HeaderText="Publish Date" DataFormatString="{0:dd/MM/yyyy HH:mm}" NullDisplayText="Immediate" />
                            ...
                            <EmptyDataTemplate><tr><td colspan="100%" class="ec-no-records">No announcements found matching your filters.</td></tr></EmptyDataTemplate>
                        </asp:GridView>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content ec-modal-content border-danger" style="border-width: 4px !important;">
                            ...
                            <div class="ec-modal-body text-center p-4">
                                <h4 class="mb-3 fw-normal">Are you sure to remove the selected announcement(s)?</h4>
