<%@ Page Title="Notifications" Language="C#" MasterPageFile="~/Masters/Staff.Master" AutoEventWireup="true" CodeBehind="Notifications.aspx.cs" Inherits="WAPP.Pages.Staff.Notifications" %>
        ...
        <div class="ec-section-gap mb-4">
            <div class="ec-section-header border-0 d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="ec-page-subtitle m-0">Stay updated with the latest system alerts.</p>
                </div>
                <div>
                            ...
                            <div class='list-group-item p-0 border-bottom <%# Eval("status").ToString() == "UNREAD" ? "notif-unread" : "notif-read" %>'>
                                <div class="d-flex w-100 justify-content-between align-items-center p-4">
                                    ...
                                    <asp:LinkButton ID="lnkViewNotification" runat="server" CommandName="View" 
                                        CommandArgument='<%# Eval("notification_id") + "|" + Eval("title") + "|" + Eval("message") + "|" + Eval("created_at") %>'
