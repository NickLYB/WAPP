<%@ Page Title="Notifications" Language="C#" MasterPageFile="~/Masters/Student.Master" AutoEventWireup="true" CodeBehind="Notifications.aspx.cs" Inherits="WAPP.Pages.Student.Notifications" %>
        ...
        <div class="ec-section-gap">
            ...
            <div class="ec-section-header border-0 d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="ec-page-subtitle m-0">Stay updated with the latest messages, session updates, and system alerts.</p>
                </div>
                <div>
        ...
        <ContentTemplate>
            <div class="modal fade" id="notificationModal" tabindex="-1" aria-labelledby="notificationModalLabel" aria-hidden="true" data-bs-backdrop="static">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content ec-modal-content border-0 shadow">
