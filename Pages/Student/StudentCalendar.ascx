    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content border-0 shadow">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label class="text-muted small fw-bold mb-1">Educator</label>
                    <div id="modalApptTutor" class="fw-bold text-dark"></div>
                </div>
                <div class="mb-3">
...
<script>
    // JavaScript function to open the modal and populate the data
    function showApptModal(event, tutor, subject, time, status) {
        event.stopPropagation(); // Prevents the calendar day from triggering a postback!
